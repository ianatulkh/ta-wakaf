...
@section('title', 'Tambah Data Nadzir')

@section('content_header')
<h1>Tambah Data Nadzir</h1>
@stop
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Tambah Data Nadzir</h3>
    </div>

    <x-alert/>

    <form class="form-horizontal" action="{{ route('admin.data-nadzir.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('POST')
