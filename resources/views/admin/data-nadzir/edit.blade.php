...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Edit Data Nadzir</h3>
    </div>

    <x-alert/>

    <form class="form-horizontal" action="{{ route('admin.data-nadzir.update', $nadzir->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="nama" name="nama" class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" 
                        placeholder="Nama" value="{{ old('nama') ?? $nadzir->nama }}">
                    @if($errors->has('nama'))
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="nik" name="nik" class="form-control {{ $errors->has('nik') ? 'is-invalid' : '' }}" 
                        placeholder="NIK" value="{{ old('nik') ?? $nadzir->nik }}">
                    @if($errors->has('nik'))
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control {{ $errors->has('tempat_lahir') ? 'is-invalid' : '' }}" 
                        placeholder="Tempat Lahir" value="{{ old('tempat_lahir') ?? $nadzir->tempat_lahir }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="form-control {{ $errors->has('tanggal_lahir') ? 'is-invalid' : '' }}" 
                        placeholder="Tanggal Lahir" value="{{ old('tanggal_lahir') ?? $nadzir->tanggal_lahir }}">
                ...
                <div class="col-sm-10">
                    <select name="id_agama" class="form-control {{ $errors->has('id_agama') ? 'is-invalid' : '' }}" autofocus>
                        @foreach ($agama as $item)
                            <option value="{{ $item->id }}" {{ (old('id_agama') ?? $nadzir->id_agama) == $item->id ? 'selected':'' }}>{{ $item->agama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-10">
                    <select name="id_pendidikan_terakhir" class="form-control {{ $errors->has('id_pendidikan_terakhir') ? 'is-invalid' : '' }}" autofocus>
                        ...
                        @foreach ($pendidikanTerakhir as $item)
                            <option value="{{ $item->id }}" {{ (old('id_pendidikan_terakhir') ?? $nadzir->id_pendidikan_terakhir) == $item->id ? 'selected':'' }}>{{ $item->tingkat }}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="pekerjaan" name="pekerjaan" class="form-control {{ $errors->has('pekerjaan') ? 'is-invalid' : '' }}" 
                        placeholder="Pekerjaan" value="{{ old('pekerjaan') ?? $nadzir->pekerjaan }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="kewarganegaraan" name="kewarganegaraan" class="form-control {{ $errors->has('kewarganegaraan') ? 'is-invalid' : '' }}" 
                        placeholder="Kewarganegaraan" value="{{ old('kewarganegaraan') ?? $nadzir->kewarganegaraan }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="rt" name="rt" class="form-control {{ $errors->has('rt') ? 'is-invalid' : '' }}" 
                        placeholder="RT" value="{{ old('rt') ?? $nadzir->rt }}">
                    @if($errors->has('rt'))
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="rw" name="rw" class="form-control {{ $errors->has('rw') ? 'is-invalid' : '' }}" 
                        placeholder="RW" value="{{ old('rw') ?? $nadzir->rw }}">
                    @if($errors->has('rw'))
                ...
                <div class="col-sm-10">
                    <select name="id_desa" class="form-control {{ $errors->has('id_desa') ? 'is-invalid' : '' }}" autofocus>
                        ...
                        @foreach ($desa as $item)
                            <option value="{{ $item->id }}" {{ (old('id_desa') ?? $nadzir->id_desa) == $item->id ? 'selected':'' }}>{{ $item->nama }}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="kecamatan" name="kecamatan" class="form-control {{ $errors->has('kecamatan') ? 'is-invalid' : '' }}" 
                        placeholder="Kecamatan" value="{{ old('kecamatan') ?? $nadzir->kecamatan }}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="kabupaten" name="kabupaten" class="form-control {{ $errors->has('kabupaten') ? 'is-invalid' : '' }}" 
                        placeholder="Kabupaten" value="{{ old('kabupaten') ?? $nadzir->kabupaten }}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="provinsi" name="provinsi" class="form-control {{ $errors->has('provinsi') ? 'is-invalid' : '' }}" 
                        placeholder="Provinsi" value="{{ old('provinsi') ?? $nadzir->provinsi }}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <small>Harus berupa gambar dengan tipe png, jpg, dan jpeg, serta ukuran kurang dari 5 MB</small> <br>
                    <small><a href="{{ Storage::disk('public')->url('berkas/ktp_nadzir/'.$nadzir->ktp ?? '') }}" target="_blank">Lihat KTP</a>, Upload ulang jika ingin menggantinya, jika tidak kosongkan</small>
                </div>
            </div>
        </div>
        
        <div class="card-footer">
            <a href="{{ route('admin.data-nadzir.index') }}" class="btn btn-default">Kembali</a>
