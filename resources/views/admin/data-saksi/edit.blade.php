...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Edit Data Saksi</h3>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <small><a href="{{ Storage::disk('public')->url('berkas/ktp_saksi/'.$saksi->ktp ?? '') }}" target="_blank">Lihat KTP</a>, Upload ulang jika ingin menggantinya, jika tidak kosongkan</small>
                </div>
            </div>
        </div>
