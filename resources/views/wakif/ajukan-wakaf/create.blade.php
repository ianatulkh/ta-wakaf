...
<div class="card">
    ...
    <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('wakif.pengajuan-wakaf.store') }}" method="post">
        ...
        <div class="card-body">
            <p>Berikut merupakan berkas yang harus diserahkan untuk pengajuan pendaftaran wakaf tanah, untuk bentuk persyaratan silahkan <a href="/persyaratan">klik disini</a> </p>

            <div class="form-group row">
                <label for="sertifikat_tanah" class="col-sm-2 col-form-label">Sertifikat Tanah / Surat Tanah Hak Milik</label>
                <div class="col-sm-10">
                    ...
                    <small>Sertifikat tanah hak milik atau bukti kepemilikan tanah harus berupa PDF, dan maksimal berukuran 5 MB</small>
                </div>
            </div>
...
<div class="card">
    <div class="card-header">
            ...
            <div class="row">
                <div class="row col-md-12">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="status_hak_nomor" name="status_hak_nomor" placeholder="Contoh ( Tanah Darat )" class="form-control {{ $errors->has('status_hak_nomor') ? 'is-invalid' : '' }}" value="{{ old('status_hak_nomor') ?? $aktaIkrar->status_hak_nomor ?? '' }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="atas_hak_nomor" name="atas_hak_nomor" placeholder="Contoh ( Persil: 60 Milik Nomor: 1293 )" class="form-control {{ $errors->has('atas_hak_nomor') ? 'is-invalid' : '' }}" value="{{ old('atas_hak_nomor') ?? $aktaIkrar->atas_hak_nomor ?? '' }}">
                ...
                <div class="row col-md-12">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="luas" name="luas" placeholder="333 M2 ( P:14 L: 32 )" class="form-control {{ $errors->has('luas') ? 'is-invalid' : '' }}" value="{{ old('luas') ?? $aktaIkrar->luas ?? '' }}">
                        @if($errors->has('luas'))
                ...
                <div class="row col-md-12">
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" id="rt" name="rt" placeholder="0001" class="form-control {{ $errors->has('rt') ? 'is-invalid' : '' }}" value="{{ old('rt') ?? $aktaIkrar->rt ?? '' }}">
                        @if($errors->has('rt'))
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" id="rw" name="rw" placeholder="0001" class="form-control {{ $errors->has('rw') ? 'is-invalid' : '' }}" value="{{ old('rw') ?? $aktaIkrar->rw ?? '' }}">
                        @if($errors->has('rw'))
                ...
                <div class="row col-md-12">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="nama_pewasiat" name="nama_pewasiat" placeholder="Nama yang mewasiatkan wakaf" class="form-control {{ $errors->has('nama_pewasiat') ? 'is-invalid' : '' }}" value="{{ old('nama_pewasiat') ?? $aktaIkrar->nama_pewasiat ?? '' }}">
                    ...
                    <div class="form-group col-md-6">
                        <label for="tahun_diwakafkan">Jika Sebagai Ahli Waris, Diwakafkan pada tahun:</label>
                        <input type="text" id="tahun_diwakafkan" name="tahun_diwakafkan" placeholder="Tahun diwakafkan" class="form-control {{ $errors->has('tahun_diwakafkan') ? 'is-invalid' : '' }}" value="{{ old('tahun_diwakafkan') ?? $aktaIkrar->tahun_diwakafkan ?? '' }}">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" id="keperluan" placeholder="Contoh: Pembangunan musholla" name="keperluan" class="form-control {{ $errors->has('keperluan') ? 'is-invalid' : '' }}" value="{{ old('keperluan') ?? $aktaIkrar->keperluan ?? '' }}">
        ...
        <div class="card-footer">
            ...
            <button type="submit" class="btn loaderClick btn-primary float-right">Kirim Ke Petugas KUA</button>
        </div>
